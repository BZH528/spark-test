package com.gmall.realtime.ads

import java.text.SimpleDateFormat
import java.util.Date

import com.alibaba.fastjson.JSON
import com.gmall.realtime.bean.OrderWide
import com.gmall.realtime.util.{MyKafkaUtil, OffsetManagerM}
...
/**
  ...
  * @Description: 从 Kafka 中读取dws层数据，并对其进行聚合处理，写回到 MySQL(ads 层),品牌统计应用程序
  */
